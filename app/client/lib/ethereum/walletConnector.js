...
/**
Config for the elementrem connector
...
elementremConfig = {
    ...
    @property elementremConfig.rollBackBy
    */
    rollBackBy: 0,
    /**
    Number of blocks to confirm a wallet

    @property elementremConfig.requiredConfirmations
    */
    requiredConfirmations: 12,
    /**
    The default daily limit used for simple accounts

    @property elementremConfig.dailyLimitDefault
    */
...
connectToNode = function(){
    ...
    // EleBlocks.detectFork(function(oldBlock, block){
    ...
    //         if(wallet.creationBlock + elementremConfig.requiredConfirmations >= block.number)

...
web3.ele.isSyncing(function(error, syncing) {
    if(!error) {
...
var connect = function(){
    ...
    if(web3.isConnected()) {
        ...
        Meteor.setTimeout(function(){
            // if in mist, tell to start gele, otherwise start with RPC
            var geleRPC = (web3.admin) ? 'gele' : 'gele --rpc --rpccorsdomain "'+window.location.protocol + '//' + window.location.host+'"';

...
Template['views_account_create'].helpers({
    ...
    */
    'defaultDailyLimit': function() {
        ...
        return typeof dailyLimit != 'undefined' ? web3.fromMey(dailyLimit,'element') :  10;
    },
    /**
    Default Name
    ...
    'submit': function(e, template){
        ...
        if(type === 'simple') {
            Wallets.insert({
                ...
                balance: '0',
                creationBlock: EleBlocks.latest.number,
                code: code
            });
        ...
        if(type === 'multisig') {
            ...
            Wallets.insert({
                ...
                name: template.find('input[name="accountName"]').value || TAPi18n.__('wallet.accounts.defaultName'),
                balance: '0',
                dailyLimit: web3.toMey(formValues.dailyLimitAmount, 'element'),

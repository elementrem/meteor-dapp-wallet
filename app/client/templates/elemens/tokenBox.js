...
@class [template] elemens_tokenBox
@constructor
*/

Template['elemens_tokenBox'].helpers({
    /**
    ...
    */
    'formattedTotalBalance': function(e){
        ...
        var walletsAndAccounts = _.map(Wallets.find().fetch().concat(EleAccounts.find().fetch()), function(account){  
...
Template['elemens_tokenBox'].events({
    /**
    Click Delete Token

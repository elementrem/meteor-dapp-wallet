...
@class [template] elemens_balance
@constructor
*/


Template['elemens_balance'].onCreated(function(){
    this._intervalId = null;
});


Template['elemens_balance'].helpers({
    /**
    ...
    */
    'convertedBalance': function(){
        ...
        if(balance){
            ...
            else if(EleTools.getUnit() === 'finney')
                return EleTools.formatBalance(TemplateVar.get('balance'), (this.showAllDecimals? '0,0.00[00000000000000]' : '0,0.00'));
            else
                return EleTools.formatBalance(TemplateVar.get('balance'), '0,0.00[000000]');
        }
    },
    /**

...
Example usage
    ...
    {{> elemens_compileContract onlyByteCode=true/false codeNotExecutable=true/false}}

@class [template] elemens_compileContract
@constructor
*/
        ...
        if(selectedType === 'source-code' && selectedContract){        
            ...
            if (replayProtectionOn){
                ...
                if (!selectedToken || selectedToken == 'element') { 
                    ...
                    sendData = splitterContract.elementSplit.getData( mainRecipient, altRecipient, {});
                } else {
...
editor = {};
Template['elemens_compileContract'].onRendered(function() {
    var template = this;
...
Template['elemens_compileContract'].onDestroyed(function() {
    if(this.aceEditor)
        this.aceEditor.destroy();
});

Template['elemens_compileContract'].helpers({
    /**
...
Template['elemens_compileContract'].events({
    /**

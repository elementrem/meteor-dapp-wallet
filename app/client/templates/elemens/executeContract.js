...
@class [template] elemens_executeContract
@constructor
*/

Template['elemens_executeContract'].onCreated(function(){
    var template = this;
    ...
    web3.ele.getCode(template.data.address, function(e, code) {
        if(!e && code.length > 2) {
...
Template['elemens_executeContract'].helpers({
    /**
    ...
    */
    'reactiveContext': function() {
        var contractInstance = web3.ele.contract(this.jsonInterface).at(this.address);
...
Template['elemens_executeContract'].events({
    /**
...
@class [template] elemens_executeContract_constant
@constructor
*/
...
Template['elemens_executeContract_constant'].onCreated(function(){
    var template = this;
...
Template['elemens_executeContract_constant'].helpers({
    /**
...
Template['elemens_executeContract_constant'].events({
    /**
...
@class [template] elemens_executeContract_function
@constructor
*/


Template['elemens_executeContract_function'].onCreated(function(){
    var template = this;
...
Template['elemens_executeContract_function'].onRendered(function(){
    // Run all inputs through formatter to catch bools
    this.$('.abi-input').trigger('change');
});

Template['elemens_executeContract_function'].helpers({
...
Template['elemens_executeContract_function'].events({
    /**

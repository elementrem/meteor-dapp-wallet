...
@class [template] elemens_event_table
@constructor
*/
...
Template['elemens_event_table'].onCreated(function(){
    this._properties = {
        cursor: {}
    };
...
Template['elemens_event_table'].helpers({
    /**
...
Template['elemens_event_table'].events({
...
@class [template] elemens_events_row
@constructor
*/

Template['elemens_events_row'].helpers({
    /**
...
Template['elemens_events_row'].events({
    /**

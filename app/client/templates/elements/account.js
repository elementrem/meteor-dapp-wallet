...
@class [template] elemens_account
@constructor
*/
...
Template['elemens_account'].rendered = function(){
...
Template['elemens_account'].helpers({
    /**
    ...
    */
    'account': function(){
        return EleAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account);
    },
    /**
    Get all tokens
    ...
    'new': function() {
        if(this.new) {
            ...
            Meteor.setTimeout(function() {
                EleAccounts.update(id, {$unset: {new: ''}});
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = EleBlocks.latest.number,
